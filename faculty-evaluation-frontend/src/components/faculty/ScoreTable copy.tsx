              ...
              >
                <TableRow>
                  ...
                  <TableCell
                    as="th"
                    rowSpan={2}
                    className="sticky top-0 z-20 bg-gradient-to-br from-primary-dark to-primary text-white font-bold text-sm border-l-4 border-l-white/30 border-b border-white/50"
                  >
                    全体合計
                  </TableCell>
                </TableRow>
